...
uid: 463222e9-30fa-425d-a311-72040fafc975
aliases: [整体思路]
linter-yaml-title-alias: 整体思路
---
...
| 6     | 神经机器翻译 ([[Neural Machine Translation]])                     | - 序列到序列模型 ([Seq2Seq](Seq2Seq.md))：[编码器](编码器.md)<br>- [[自注意力机制 Self-attention]] (Attention)：点积注意力、缩放点积注意力<br>- Beam search：提高翻译质量的方法 |                   |
